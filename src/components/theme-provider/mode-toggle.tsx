...
export function ModeToggle() {
  ...
  size="icon"
  className="inline-flex rounded-full relative hover:h-10 hover:w-10 hover:cursor-pointer"
>
  ...
  {theme === "dark" && <Moon className="h-[1.2rem] w-[1.2rem] transition-all text-blue-50" />}
</Button>
    </>
  )
}
